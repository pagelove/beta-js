/**
 * DOMSubscriber — subscribe to DOM mutations by CSS selector.
 *
 * Vendored from https://github.com/pagelove/dom-subscriber at commit
 * 6b77709. Identical to cde4007, the revision this library previously
 * loaded from cdn.pagelove.net.
 *
 * Do not edit this file. Change it upstream and re-vendor, so the two copies
 * do not drift.
 */
